						...
						'options' => array(
							'layout' => array(
								...
								'options' => array(
									...
									'title-side-margin' => array(
										'title' => esc_html__('Title Left/Right Margin', 'infinite'),
										'type' => 'text',
										'data-input-type' => 'pixel'
									),
									'title-background-radius' => array(
										'title' => esc_html__('Page Title Background Radius', 'infinite'),
										'type' => 'text',
										'data-input-type' => 'pixel',
										'condition' => array( 'enable-header-area' => 'enable', 'enable-page-title' => 'enable' )
									),
									'title-background-bottom-radius' => array(
										'title' => esc_html__('Page Title Background Bottom Radius', 'infinite'),
										'type' => 'text',
										'data-input-type' => 'pixel',
										'condition' => array( 'enable-header-area' => 'enable', 'enable-page-title' => 'enable' )
									),
							...
							'float-social' => array(
								...
								'options' => array(
									...
									'float-social' => array(
										'title' => esc_html__('Add Color Section(Use Float Social ID in Wrapper Setting > General Tab)', 'infinite'),
										'type' => 'custom',
										'item-type' => 'tabs',
										'extra' => array(
											'item-title' => esc_html__('Item\'s ID', 'infinite')
										),
										'options' => array(
											'title' => array(
												'title' => esc_html__('Section ID', 'infinite'),
												'type' => 'text',
											),
											'section-color' => array(
												'title' => esc_html__('Social Color', 'infinite'),
												'type' => 'colorpicker',
											),
											'section-hover-color' => array(
												'title' => esc_html__('Social Hover Color', 'infinite'),
												'type' => 'colorpicker',
											)
										),
										'wrapper-class' => 'gdlr-core-fullsize'
							...
							'title' => array(
								...
								'options' => array(
									...
									'blog-title-background-radius' => array(
										'title' => esc_html__('Blog Title Background Radius', 'infinite'),
										'type' => 'text',
										'data-input-type' => 'pixel',
										'condition' => array( 
											'blog-title-style' => array('default', 'small', 'large', 'custom'),
