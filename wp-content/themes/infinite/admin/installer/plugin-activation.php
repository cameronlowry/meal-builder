<?php 
	...
	*/		
	...
	if( !function_exists('infinite_verified_plugins') ){
		function infinite_verified_plugins(){
			$ret = array();

			$plugins = array(
				'goodlayers-core' => esc_html__('Goodlayers Core', 'infinite'), 
				'goodlayers-core-portfolio' => esc_html__('Goodlayers Core Portfolio', 'infinite'), 
				'goodlayers-core-personnel' => esc_html__('Goodlayers Core Personnel', 'infinite'), 
				'goodlayers-core-twitter' => esc_html__('Goodlayers Core Twitter', 'infinite'), 
				'revslider' => esc_html__('Revolution Slider', 'infinite')
			);
			
			$plugin_versions = get_option('infinite-plugins-version', array());
			foreach( $plugins as $slug => $title ){
				$download_url = infinite_get_download_url($slug);
	...
	if( !function_exists('infinite_register_required_plugins') ){
		function infinite_register_required_plugins(){
			...
			$plugins = array_merge(infinite_verified_plugins(), array(
				array(
