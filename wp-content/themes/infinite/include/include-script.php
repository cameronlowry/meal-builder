	...
	if( !function_exists('infinite_include_scripts') ){
		function infinite_include_scripts(){
			...
			if( !function_exists('gdlr_core_front_script') ){
				wp_enqueue_style('infinite-font-awesome', get_template_directory_uri() . '/plugins/font-awesome/css/font-awesome.min.css');
				wp_enqueue_style('infinite-elegant-font', get_template_directory_uri() . '/plugins/elegant-font/style.css');
			}
			...
			// include site script
			wp_enqueue_style('infinite-mmenu', get_template_directory_uri() . '/css/mmenu.css');
			wp_enqueue_script('infinite-mmenu', get_template_directory_uri() . '/js/mmenu.js', array('jquery', 'jquery-effects-core'), '1.0.0', true );
			wp_enqueue_script('infinite-jquery-superfish', get_template_directory_uri() . '/js/jquery.superfish.js', array('jquery', 'jquery-effects-core'), '1.0.0', true );
